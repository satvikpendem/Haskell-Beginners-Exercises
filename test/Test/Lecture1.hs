...
lecture1Spec = describe "Lecture 1" $ do
    ...
    describe "lowerAndGreater" $ do
        it "Empty list" $
            lowerAndGreater 10 []
                `shouldBe` "10 is greater than 0 elements and lower than 0 elements"
        it "All elements equal" $
            lowerAndGreater 3 [3, 3, 3, 3]
                `shouldBe` "3 is greater than 0 elements and lower than 0 elements"
        it "All elements lower" $
            lowerAndGreater 10 [1 .. 5]
                `shouldBe` "10 is greater than 5 elements and lower than 0 elements"
        it "All elements greater" $
            lowerAndGreater 10 [11 .. 20]
                `shouldBe` "10 is greater than 0 elements and lower than 10 elements"
        it "Mix and match" $
            lowerAndGreater 2 [7, 1, 2, 4, 5, 8, 2, 1, 0]
                `shouldBe` "2 is greater than 3 elements and lower than 4 elements"
